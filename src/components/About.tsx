...
export function About() {
  return (
    <section id="about" className="h-screen bg-gradient-to-b from-gray-200 via-white to-gray-200">
      <div className="mx-8 pt-40 md:mx-auto w-3/4 2xl:w-2/4 lg:pt-0 ">
        ...
        <p className="bg-gradient-to-l from-gray-200 via-white to-gray-200 rounded-2xl p-8 text-sm lg:text-lg lg:p-12">
