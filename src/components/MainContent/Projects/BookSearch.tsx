...
export function BookSearch() {
  return (
    <div className="gap-8 shadow-inner shadow-gray-300 bg-gradient-to-l from-gray-200 via-white to-gray-200 rounded-2xl mx-8 mb-14 w-3/4 md:mx-auto lg:grid lg:grid-cols-[50%_50%] lg:text-lg lg:p-12 2xl:w-2/3 3xl:w-2/4">
      <Link href="https://akehaa-book-search.vercel.app/" target="_blank" aria-label="GitHub Repo">
