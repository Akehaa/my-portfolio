    ...
    <>
      {
        language === "en" ?
          ...
          <div className="mx-8 pt-60 md:mx-auto w-3/4 lg:pt-40 xl:w-3/4 3xl:w-4/6" lang="pt-br">
            ...
            <p className="shadow-inner shadow-gray-300 bg-gradient-to-l from-gray-200 via-white to-gray-200 rounded-2xl p-8 text-sm lg:text-lg lg:p-12">
              Tenho 25 anos e sou um desenvolvedor Full Stack React/Node com inglês avançado(C1). Você pode ver meus projetos no <Link href="https://github.com/deneruaraujo?tab=GitHubsitories" className="text-redishpinksh" target="_blank">GitHub</Link>.
              <br />
              <br />
