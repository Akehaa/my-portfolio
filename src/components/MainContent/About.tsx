  ...
  return (
    <div className="mx-8 pt-60 md:mx-auto w-3/4 lg:pt-40 xl:w-3/4 3xl:w-4/6">
      ...
      <p className="shadow-inner shadow-gray-300 bg-gradient-to-l from-gray-200 via-white to-gray-200 rounded-2xl p-8 text-sm lg:text-lg lg:p-12">
        A 24-year-old Front-end <span className="font-bold">React</span> Developer with over a year of coding experience. I gained my coding skills through the <Link href="https://www.rocketseat.com.br/ignite?utm_source=site_rocketseat&utm_medium=tabs_programas&utm_campaign=redirecionameto&utm_term=organic&utm_content=button" className="text-[#8257E5] hover:font-bold" target="_blank">Rocketseat ReactJS Specialization Bootcamp</Link>. You can find the projects on my <Link href="https://github.com/Akehaa?tab=repositories" className="text-redishpinksh hover:font-bold" target="_blank">GitHub</Link>.<br />
