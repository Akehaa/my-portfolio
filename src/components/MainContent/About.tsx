...
export function About() {
  return (
    <div className="mx-8 pt-52 md:mx-auto w-3/4 lg:pt-0 xl:w-3/4 3xl:w-2/4">
      ...
      <p className="shadow-inner shadow-gray-300 bg-gradient-to-l from-gray-200 via-white to-gray-200 rounded-2xl p-8 text-sm lg:text-lg lg:p-12">
        ...
        I'm used to code using <span className="font-bold">NextJS</span>, <span className="font-bold">TypeScript</span>, <span className="font-bold">TailwindCSS with PostCSS</span> and to use <span className="font-bold">Figma</span>. I'm constantly exploring new technologies and i really enjoy staying up to date with the latest trends in the market.
      </p>
    </div>
  )
}