...
import { SiCss3, SiHtml5, SiJavascript, SiNextdotjs, SiReact, SiTailwindcss, SiTypescript, SiNodedotjs, SiNestjs, SiVitest, SiPostgresql, SiDocker, SiPrisma } from 'react-icons/si';
