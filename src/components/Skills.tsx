      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <button className='cursor-default' aria-label='HTML5'>
            <SiHtml5 size="auto" className="text-[#DC3D1C] w-9 hover:-translate-y-1 duration-200 lg:w-11 " />
          </button>
        </Tooltip.Trigger>
        <Tooltip.Portal>
          <Tooltip.Content
      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <button className='cursor-default ' aria-label='CSS3'>
            <SiCss3 size="auto" className="text-[#0062B1] w-9 hover:-translate-y-1 duration-200 lg:w-11" />
          </button>
        </Tooltip.Trigger>
        <Tooltip.Portal>
          <Tooltip.Content
      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <button className='cursor-default' aria-label='JavaScript'>
            <SiJavascript size="auto" className="text-[#EAD41C] bg-black w-9 hover:-translate-y-1 duration-200 lg:w-11 " />
          </button>
        </Tooltip.Trigger>
        <Tooltip.Portal>
          <Tooltip.Content
      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <button className='cursor-default' aria-label='NextJS'>
            <SiNextdotjs size="auto" className="w-9 hover:-translate-y-1 duration-200 lg:w-11" />
          </button>
        </Tooltip.Trigger>
        <Tooltip.Portal>
          <Tooltip.Content
      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <button className='cursor-default' aria-label='TypeScript'>
            <SiTypescript size="auto" className="text-[#2F72BC] w-9 hover:-translate-y-1 duration-200 lg:w-11" />
          </button>
        </Tooltip.Trigger>
        <Tooltip.Portal>
          <Tooltip.Content
      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <button className='cursor-default' aria-label='React'>
            <SiReact size="auto" className="text-[#5CCFEE] w-9 hover:-translate-y-1 duration-200 lg:w-11" />
          </button>
        </Tooltip.Trigger>
        <Tooltip.Portal>
          <Tooltip.Content
      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <button className='cursor-default' aria-label='Tailwind'>
            <SiTailwindcss size="auto" className="text-[#35B3EB] w-9 hover:-translate-y-1 duration-200 lg:w-11" />
          </button>
        </Tooltip.Trigger>
        <Tooltip.Portal>
          <Tooltip.Content
