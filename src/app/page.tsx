...
export default function Home() {
  return (
    <header className="bg-gradient-to-b from-gray-200 via-white to-gray-200 flex flex-col items-center justify-center h-screen lg:flex-row">
      <Image src={profile} width={250} height={0} alt="profile picture" className="mb-12 rounded-full shadow-[4px_10px_25px_rgba(0,0,0,0.3)] w-52 h-auto lg:w-[250px]"></Image>
      <div className="flex flex-col items-center mx-10 text-center gap-6">
        ...
        <p className="text-lg">
          ...
          I am a <span className="text-redishpinksh">Front-end React Web Developer <span className="text-black">from</span> Brazil</span><br /> that
